...
function generateDropdownList(menuGroups) {
...
dropdownItems.forEach((item) => {
    ...
    dropdownBtn.addEventListener('click', () => {
        const currentDropdownMenu = document.querySelector('.show-dropdown');
        toggleItem(item);
        if (currentDropdownMenu && currentDropdownMenu !== item)
            toggleItem(currentDropdownMenu);
    });
});
